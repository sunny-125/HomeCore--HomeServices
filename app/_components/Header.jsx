...
// return ( <div className="p-5 shadow-sm flex justify-between">
// {/* Left Section */} <div className="flex items-center gap-8"> <Image src="/logo.svg" alt="logo" width={180} height={100} />
...
//         Home
//       </Link>
//       <h2 className="hover:scale-105 hover:text-primary cursor-pointer font-family=Arial">
//         Services
//       </h2>
